...
_.f=g
_.r=h
_.a=i},akF:function akF(d){this.a=d},
aJi(){var x=0,w=A.U(y.k),v
var $async$aJi=A.Q(function(d,e){if(d===1)return A.R(e,w)
while(true)switch(x){case 0:v=$.lB().v3("assets/ArtalaxiesMarket.json").av(0,new B.aDN(),y.w).av(0,new B.aDO(),y.k)
x=1
break
...
aDN:function aDN(){},
aDO:function aDO(){},
a7l(d,e,f){return B.b9q(d,e,f)},
b9q(d,e,f){var x=0,w=A.U(y.h),v
var $async$a7l=A.Q(function(g,h){if(g===1)return A.R(h,w)
while(true)switch(x){case 0:$.LG().at(C.q,"getLatestTransaction executed",null,null)
x=3
return A.a0(d.av(0,new B.aDX(f,e),y.h),$async$a7l)
case 3:v=h
x=1
break
case 1:return A.S(v,w)}})
return A.T($async$a7l,w)},
a7m(d,e){return B.b9s(d,e)},
b9s(d,e){var x=0,w=A.U(y.o),v
var $async$a7m=A.Q(function(f,g){if(f===1)return A.R(g,w)
while(true)switch(x){case 0:$.LG().at(C.q,"getNFTData executed",null,null)
x=3
return A.a0(d.av(0,new B.aE_(e),y.o),$async$a7m)
case 3:v=g
x=1
break
case 1:return A.S(v,w)}})
...
if(t==null)t=""
return A.i1(A.anm(C.X,!1,A.dc(A.a([v,A.tt(w,!1,w,w,A.ar(t,w,w,w,A.N(e).F.y,w,w),u,w),D.Q8],y.u),C.Z,C.z6,C.J),C.l,C.lZ,0,2,!0,w,w,4,w,w,8,w,4,w,w,w,w,new B.akF(x),C.G,C.ke,w,w,C.i4),E.mJ,w,E.kf)}}
B.cu.prototype={}
...
var $async$$1=A.Q(function(e,f){if(e===1)return A.R(f,w)
while(true)switch(x){case 0:v=J.f0(u.a,new B.aDZ(d),y.t).du(0)
x=1
break
case 1:return A.S(v,w)}})
return A.T($async$$1,w)},
...
s=d.a
r=J.l(s)
t.at(C.cI,"getNFTData.data: "+r.gGd(s),null,null)
t.at(C.cI,"getNFTData.address: "+r.gpK(s),null,null)
t.at(C.cI,"getNFTData.transactionHash: "+r.gY4(s),null,null)
t.at(C.cI,"getNFTData.transactionIndex: "+r.garG(s),null,null)
t.at(C.cI,"getNFTData.toString: "+("Event: "+r.gUy(s)+" "+r.gUz(s)+" with args "+A.d(r.gpT(s))),null,null)
q=B
p=r.gpK(s)
o=J.b_(J.V(r.gpT(s),2))
x=3
return A.a0($.aKk().av(0,new B.aDY(d,u.a),y.w),$async$$1)
...
s=J.l(t)
r=C.b.Z(s.gpK(t)+"/",J.b_(J.V(s.gpT(t),2)))
q=A.cU(J.V(d.a,r))
x=q==null?3:4
break
case 3:p=J
...
case 5:q=p.b_(f)
case 4:d.nS("String",C.b.Z(s.gpK(t)+"/",J.b_(J.V(s.gpT(t),2))),q)
v=q
x=1
break
case 1:return A.S(v,w)}})
...
x(B.nM,A.aL)
x(B.akF,A.e9)
w(A.bH,[B.aDN,B.aDO,B.aDX,B.aE_,B.aDZ,B.aDY])
x(B.cu,A.x)})()
...
D.Q8=new A.ts(null,D.aba,null,null,!1,D.a5b,null,null,F.iM,null)})();(function lazyInitializers(){var x=a.lazyFinal
x($,"bgc","a7W",()=>B.aJi())})()}
$__dart_deferred_initializers__["8f+PVTce9tyQYj63Jn85PMN+Mz0="] = $__dart_deferred_initializers__.current
