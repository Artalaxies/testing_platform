...
F=c[28]
B.rW.prototype={
pq(d,e){return this.ah2(d,e)},
ah1(){return this.pq(null,null)},
ah2(d,e){var x=0,w=A.X(y.v),v,u=this
var $async$pq=A.T(function(f,g){if(f===1)return A.U(g,w)
while(true)switch(x){case 0:x=3
return A.a4(E.a60(d,e).aM(0,new B.ai8(),y.m).aM(0,new B.ai9(),y.j).aM(0,new B.aia(u),y.v),$async$pq)
case 3:v=g
x=1
break
case 1:return A.V(v,w)}})
return A.W($async$pq,w)},
b1(){var x=this
x.ah1().aM(0,new B.aig(x),y.F)
A.b(x.c,"windowLogger").aS(C.x,"list.length"+C.e.j(x.r.length),null,null)
x.Bs()},
P(d,e){var x,w,v,u,t,s,r=null,q=y.q
A.dR(e,C.aq,q).toString
x=y.h
w=A.b7(A.fi("Marketplace",r,"marketplace",A.a([],x),r),r,r,r,A.a1(e).L.a,C.T,r)
A.dR(e,C.aq,q).toString
v=y.u
w=A.iM(A.iK(A.a([new A.b6(D.Ol,w,r),A.b7(A.fi("\nNFT Derivative MarketPlace \nDiscover Licenses and Merchandise\n",r,"header_description",A.a([],x),r),r,r,r,A.a1(e).L.b,C.T,r)],v),!0,!0,!0))
u=C.d.cf($.jz.a,300)
t=this.r
s=A.a9(t).h("aj<1,hO<@>>")
...
B.aid.prototype={
$1(d){var x=y.b
return A.ke(I.uF(new B.aic(this.a),null,x),d,x)},
$S:162}
B.aic.prototype={
$2(d,e){var x=null
