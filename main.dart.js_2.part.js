...
x.d.e=!1
y=B.dJ(new B.dS(B.hd(B.H(x).a,null)))
B.dy(x.c,"windowLogger")
x.c=y},
aX(){},
az(d){this.d.b.$1(d)},
...
if(y!=null)y.p(0)
this.bA(0)},
eF(){B.b(this.a.c,"windowLogger").aE(C.u,"deactivate",null,null)
this.a.toString
this.lS()}}
var z=a.updateTypes(["~(~())"])
A.atX.prototype={
...
$__dart_deferred_initializers__["vCt8HGNNY8OVm5zxthisLfr8ZGc="] = $__dart_deferred_initializers__.current
